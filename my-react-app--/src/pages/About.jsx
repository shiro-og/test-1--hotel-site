  ...
  return (
    ...
    <div className="pages">
      ...
      <div className="img-abt">
       <img src={`${import.meta.env.BASE_URL}images/welcome.webp`} alt="welcome" style={{ width: "250px" }} />

       <img src={`${import.meta.env.BASE_URL}images/abb.webp`} alt="about" style={{ width: "250px" }} />

       <img src={`${import.meta.env.BASE_URL}images/always.webp`} alt="always" style={{ width: "250px" }} /> 
      </div>
